...
if __name__ == '__main__':
    ...
    while True:
        if TrufflebotSerial.in_waiting > 0:
            ...
            predicted_value_37 = Classifier_MQ3_MQ7.predict([[MQ3,MQ7]])
            predicted_value_92 = Classifier_MQ9_MQ2.predict([[MQ9,MQ2]])
            predicted_value_PT = Classifier_Pressure_Temperature.predict([[Pressure, Temperature]])
            print(predicted_value_37)
            print(predicted_value_92)
            print(predicted_value_PT)
            
            if predicted_value_37 >= 0.92 and predicted_value_92 >= 0.92 and predicted_value_PT >= 0.92:
